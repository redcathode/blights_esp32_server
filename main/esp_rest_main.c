...
#include "lighting_control_functions.h"
...
#define WW_LEDC_TIMER              LEDC_TIMER_0
#define WW_LEDC_MODE               LEDC_LOW_SPEED_MODE
#define WW_LEDC_OUTPUT_IO          (6) // Define the output GPIO
#define WW_LEDC_CHANNEL            LEDC_CHANNEL_0
#define WW_LEDC_DUTY_RES           LEDC_TIMER_10_BIT // Set duty resolution to 10 bits
#define WW_LEDC_DUTY               (64) 
#define WW_LEDC_FREQUENCY          (20000) 
...
static void initialize_attached_hw(void) {
    ledc_timer_config_t ledc_timer = {
        .speed_mode       = WW_LEDC_MODE,
        .timer_num        = WW_LEDC_TIMER,
        .duty_resolution  = WW_LEDC_DUTY_RES,
        .freq_hz          = WW_LEDC_FREQUENCY,  // Set output frequency at 4 kHz
    ...
    ledc_channel_config_t ledc_channel = {
        .speed_mode     = WW_LEDC_MODE,
        .channel        = WW_LEDC_CHANNEL,
        .timer_sel      = WW_LEDC_TIMER,
        .intr_type      = LEDC_INTR_DISABLE,
        .gpio_num       = WW_LEDC_OUTPUT_IO,
